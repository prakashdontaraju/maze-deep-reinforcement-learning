...
class DQNetwork:
    """Sets up deque network"""

    def __init__(
      self, state_size, action_size, learning_rate, name='DQNetwork'):
        ...
        with tf.variable_scope(name):
            ...
            self.actions_ = tf.placeholder(
              tf.float32, [None, 4], name="actions_")
            ...
            self.maxpool1 = tf.layers.max_pooling2d(
            ...
            self.maxpool2 = tf.layers.max_pooling2d(
            ...
            self.maxpool3 = tf.layers.max_pooling2d(
              inputs = self.conv3_out,
              pool_size = [3,3],
              strides = [2,2],
              padding = "VALID",
              name = "maxpool3")
            ...
            self.conv4_batchnorm = tf.layers.batch_normalization(
              self.conv4,
              training = True,
              epsilon = 1e-5,
              name = 'batch_norm4')
            ...
            self.maxpool4 = tf.layers.max_pooling2d(
              inputs = self.conv4_out,
              pool_size = [2,2],
              strides = [2,2],
              padding = "VALID",
              name = "maxpool4")
            ...
            self.dropout1 = tf.layers.dropout(
              inputs=self.fc1, rate=0.3, training = True)
            ...
            self.dropout2 = tf.layers.dropout(
              inputs=self.fc2, rate=0.4, training = True)
